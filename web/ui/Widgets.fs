...
module DebounceComponent =
    ...
    type DebounceView(props) as this =
        ...
        override _.shouldComponentUpdate(nextProps, _) = props.model <> nextProps.model
